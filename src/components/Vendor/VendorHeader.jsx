const VendorHeader = ({ open, setOpen, title }) => {
    ...
    <header
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-xs text-violet-400">ThemeMatrix Vendor</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        <div className="text-right hidden sm:block">
          <p className="text-sm font-bold text-gray-700">{vendorName}</p>
          <p className="text-xs text-violet-500">Template Developer</p>
        </div>
        <div
